...
public class AlmostAllInOne {
	...
	public static void main(String args[])
	{
		...
		try {
			System.getProperties().load(AlmostAllInOne.class.getResourceAsStream("/fr/feasil/kittens/main/version.properties"));
		...
		if ( System.getProperty(AlmostAllInOne.class.getCanonicalName() + ".VERSION") != null )
			version = System.getProperty(AlmostAllInOne.class.getCanonicalName() + ".VERSION");
		else version = "?";
		if ( System.getProperty(AlmostAllInOne.class.getCanonicalName() + ".SUBVERSION") != null )
			subversion = System.getProperty(AlmostAllInOne.class.getCanonicalName() + ".SUBVERSION");
		else subversion = "?";
		if ( System.getProperty(AlmostAllInOne.class.getCanonicalName() + ".REVISION") != null )
			revision = System.getProperty(AlmostAllInOne.class.getCanonicalName() + ".REVISION");
		else revision = "?";
		//
